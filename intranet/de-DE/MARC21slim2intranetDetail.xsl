...
<xsl:call-template name="showAuthor">
 ...
 <span class="results_summary type"><span class="label">Materialtyp: </span>
 ...
 <span class="results_summary volumes"><span class="label">Bände: </span>
 <a>
 <xsl:choose>
 <xsl:when test="$UseControlNumber = '1' and marc:controlfield[@tag=001]">
 ...
 <span class="results_summary set"><span class="label">Gesamtaufnahme: </span>
 ...
 <span class="results_summary publisher"><span class="label">Veröffentlichungsangaben: </span>
 ...
 <span class="results_summary edition"><span class="label">Auflage: </span>
 ...
 <span class="results_summary cartographic_data"><span class="label">Kartografisches Daten: </span>
 ...
 <span class="results_summary description"><span class="label">Beschreibung: </span>
 ...
 <span class="results_summary other_title"><span class="label">Weitere Titel: </span>
 ...
 <span class="results_summary translated_title"><span class="label">Übersetzter Titel: </span>
 ...
 <span class="results_summary uniform_title"><span class="label">Einheitssachtitel: </span>
 ...
 <span class="results_summary related_works"><span class="label">Verwandte Werke: </span>
 ...
 <span class="results_summary contained_works"><span class="label">Enthaltene Werke: </span>
 ...
 <span class="results_summary subjects"><span class="label">Schlagwörter: </span>
...
<!-- Other classification -->
 ...
 <span class="results_summary online_resources"><span class="label">Online-Ressourcen: </span>
 ...
 <span class="label">
 <xsl:choose>
 <xsl:when test="@ind1=0"><xsl:text>Schlagwort: </xsl:text></xsl:when>
 <xsl:when test="@ind1=1"><xsl:text>Rezension: </xsl:text></xsl:when>
 <xsl:when test="@ind1=2"><xsl:text>Bereich und Inhalt: </xsl:text></xsl:when>
 <xsl:when test="@ind1=3"><xsl:text>Zusammenfassung: </xsl:text></xsl:when>
 <xsl:when test="@ind1=4"><xsl:text>Inhaltsempfehlung: </xsl:text></xsl:when>
 <xsl:when test="@ind1=8"><xsl:text></xsl:text></xsl:when>
 <xsl:otherwise><xsl:text>Zusammenfassung: </xsl:text></xsl:otherwise>
 </xsl:choose>
 </span>
 <xsl:call-template name="subfieldSelect">
 <xsl:with-param name="codes">abc</xsl:with-param>
 ...
 <span class="results_summary holdings_note basic_bibliographic_unit"><span class="label">Bestand: </span>
 ...
 <span class="results_summary holdings_note supplementary_material"><span class="label">Supplemente: </span>
 ...
 <span class="results_summary holdings_note indexes"><span class="label">Indices: </span>
 ...
 <span class="results_summary supplement"><span class="label">Beilage: </span>
 ...
 <span class="results_summary supplement_parent"><span class="label">Beilage zu: </span>
 ...
 <span class="results_summary other_editions"><span class="label">Andere Ausgaben: </span>
 ...
 <span class="results_summary other_relationship_entry"><span class="label">Andere related works: </span>
 ...
 Keine Anzeige im OPAC </span>
 </xsl:when>
 <xsl:otherwise>
 <xsl:if test="$OPACBaseURL!=''">
 <span class="results_summary opac_view"><span class="label">OPAC-Sicht: </span>
 <a><xsl:attribute name="href"><xsl:value-of select="$OPACBaseURL"/>/cgi-bin/koha/opac-detail.pl?biblionumber=<xsl:value-of select="str:encode-uri(marc:datafield[@tag=999]/marc:subfield[@code='c'], true())"/></xsl:attribute><xsl:attribute name="target">_blank</xsl:attribute>In neuem Fenster öffnen</a>.
 </span>
 </xsl:if>
 </xsl:otherwise>
 </xsl:choose>
 ...
 <!-- #13383 -->
 <xsl:when test="@tag=100"><span class="byAuthor">Verfasser*in: </span></xsl:when>
 <xsl:when test="@tag=110 or @tag=111"><span class="byAuthor">Herausgeber*in: </span></xsl:when>
<xsl:when test="@tag=245 and marc:subfield[@code='c']"><span class="byAuthor">Herausgebende Körperschaft: </span></xsl:when> 
<!--#13382 Changed Additional author to contributor -->
 <xsl:when test="@tag&gt;=700"><span class="byAuthor">Mitwirkende(r): </span></xsl:when>
 </xsl:choose>
 <a>
 <xsl:choose>
<xsl:when test="@tag=245 and marc:subfield[@code='c']">
<xsl:attribute name="href">
