...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="marc:record">
        ...
        <xsl:variable name="schemaOrgType">
            <xsl:choose>
                <xsl:when test="$materialTypeLabel='Book'">Buch</xsl:when>
                <xsl:when test="$materialTypeLabel='Map'">Karte</xsl:when>
        ...
        <xsl:element name="div">
            ...
            <xsl:attribute name="typeof">
                <xsl:value-of select='$schemaOrgType'/>
            </xsl:attribute>
            ...
            <xsl:variable name="show_analytics_link"
                          select="marc:variables/marc:variable[@name='show_analytics_link']"/>
                        ...
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                <xsl:attribute name="href">/cgi-bin/koha/opac-search.pl?q=ti,phr:"<xsl:value-of
                                        select="$title"/>"+OR+host-item,phr="<xsl:value-of select="$title"/>"+NOT+(bib-level:a+OR+bib-level:b)
                                </xsl:attribute>
                            </xsl:otherwise>
                        </xsl:choose>
                                ...
                                <xsl:if test="@code='b'">
                                    <span property="publisher" typeof="Organization">
                                        <span property="name" class="publisher_name">
                                            <a>
                                                <xsl:attribute name="href">/cgi-bin/koha/opac-search.pl?q=Provider:<xsl:value-of
                                                        select="str:encode-uri(current(), true())"/>
                                                </xsl:attribute>
                                                <xsl:value-of select="current()"/>
                                            </a>
                                    ...
                                    <span property="datePublished" class="publisher_date">
                                        <a>
                                            <xsl:attribute name="href">
                                                /cgi-bin/koha/opac-search.pl?q=copydate:"<xsl:value-of
                                                    select="str:encode-uri(current(), true())"/>"
                                            </xsl:attribute>
                                            <xsl:value-of select="current()"/>
                                        </a>
                        ...
                        <xsl:for-each select="marc:datafield[substring(@tag, 1, 1) = '6'][not(@tag=655)]">
                            <li>
                                <span property="keywords">
                                    <a>
                                        <xsl:attribute name="class">Fach</xsl:attribute>
                                        <xsl:choose>
                                            ...
                                            <xsl:when test="$TraceSubjectSubdivisions='1'">
                                                <xsl:attribute name="href">/cgi-bin/koha/opac-search.pl?q=
                                                    <xsl:call-template name="subfieldSelectSubject">
                                                        <xsl:with-param name="codes">abcdfgklmnopqrstvxyz
                                                        </xsl:with-param>
                                            ...
                                            <xsl:otherwise>
                                                <xsl:attribute name="href">
                                                    /cgi-bin/koha/opac-search.pl?q=su<xsl:value-of
                                                        select="$SubjectModifier"/>:<xsl:value-of
                            ...
                            <li>
                                <a>
                                    <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                            <xsl:attribute name="href">
                                                /cgi-bin/koha/opac-search.pl?q=index-term-genre<xsl:value-of
                                                    select="$SubjectModifier"/>:<xsl:value-of
                                                    select="$TracingQuotesLeft"/><xsl:value-of
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$OPACTrackClicks='track'">
                                                <xsl:attribute name="href">/cgi-bin/koha/tracklinks.pl?uri=<xsl:value-of
                                                        select="str:encode-uri(marc:subfield[@code='u'], true())"/>&amp;biblionumber=<xsl:value-of
                                                        select="$biblionumber"/>
                                                </xsl:attribute>
                                            </xsl:when>
                                            ...
                                            <xsl:otherwise>
                                                <xsl:attribute name="href">
                                                    <xsl:call-template name="AddMissingProtocol">
                                                        <xsl:with-param name="resourceLocation"
                                                                        select="marc:subfield[@code='u']"/>
                                                        <xsl:with-param name="indicator1" select="@ind1"/>
                                                        <xsl:with-param name="accessMethod"
                            ...
                            <li>
                                ...
                                <a>
                                    <xsl:choose>
                                        <xsl:when test="$UseControlNumber = '1' and marc:subfield[@code='w']">
                                            <xsl:attribute name="href">
                                                /cgi-bin/koha/opac-search.pl?q=Control-number:
                                                <xsl:call-template name="extractControlNumber">
                                                    <xsl:with-param name="subfieldW" select="marc:subfield[@code='w']"/>
                                                </xsl:call-template>
                                            </xsl:attribute>
            ...
            <xsl:if test="marc:datafield[@tag=785]">
                <xsl:for-each select="marc:datafield[@tag=785]">
                    <xsl:if test="@ind1=0">
                        ...
                        <xsl:if test="marc:subfield[@code='n']">
                            <span class="results_summary succeeding_entry_note">
                                <xsl:value-of select="marc:subfield[@code='n']"/>
                            </span>
                        </xsl:if>
            ...
            <xsl:variable name="OpenURLImageLocation"
                          select="marc:sysprefs/marc:syspref[@name='OpenURLImageLocation']"/>
                            ...
                            <xsl:if test="$OPACPlayMusicalInscripts = 1">
                                <div class="audio_controls hide">
                                    <button class="btn play_btn">
                                        ...
                                        <xsl:text> Probe abspielen</xsl:text>
                                    </button>
                                </div>
                            </xsl:if>
                        </xsl:if>
                                ...
                                <xsl:choose>
                                    <xsl:when test="@tag=245">
                                            <xsl:attribute name="href">
                                                ...
                                                <xsl:value-of
                                                        select="str:encode-uri(marc:subfield[@code='c'], true())"/>
                                                <xsl:text>"</xsl:text>
                                                    ...
                                                    <xsl:if test="@tag=110 and boolean(marc:subfield[@code='c' or @code='d' or @code='n' or @code='t'])">
                                                        <span class="titleportion">
                                                            ...
                                                            <xsl:call-template name="chopPunctuation">
                                                                <xsl:with-param name="chopString">
                                                                    <xsl:call-template name="subfieldSelect">
                                                                        <xsl:with-param name="codes">cdnt
                                                                        </xsl:with-param>
                                                                    </xsl:call-template>
                                                                </xsl:with-param>
                                                            </xsl:call-template>
                                                    ...
                                                    <xsl:if test="@tag=111 and boolean(marc:subfield[@code='c' or @code='d' or @code='g' or @code='n' or @code='t'])">
                                                        <span class="titleportion">
                                                            ...
                                                            <xsl:call-template name="chopPunctuation">
                                                                <xsl:with-param name="chopString">
                                                                    <xsl:call-template name="subfieldSelect">
                                                                        <xsl:with-param name="codes">cdgnt
                                                                        </xsl:with-param>
                                                                    </xsl:call-template>
                                                                </xsl:with-param>
                                                            </xsl:call-template>
                                                    ...
                                                    <xsl:if test="@tag=700 and $titleportionfields">
                                                        <span class="titleportion">
                                                            ...
                                                            <xsl:call-template name="chopPunctuation">
                                                                <xsl:with-param name="chopString">
                                                                    <xsl:call-template name="subfieldSelect">
                                                                        <xsl:with-param name="codes">fghjklmnoprstux
                                                                        </xsl:with-param>
                                                                    </xsl:call-template>
                                                                </xsl:with-param>
                                                            </xsl:call-template>
