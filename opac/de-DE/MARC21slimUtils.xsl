 ...
 * Pitfalls:
 ...
 <span class="label">Vertrieb: </span>
 </xsl:when>
 <xsl:when test="$ind2='3'">
 <span class="label">Hersteller: </span>
 </xsl:when>
 <xsl:when test="$ind2='4'">
 <span class="label">Copyright-Datum: </span>
 </xsl:when>
 <xsl:otherwise>
 ...
 <xsl:with-param name="langLabel">Sprache: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='b']"/>
 <xsl:with-param name="langLabel">Sprache der Zusammenfassung: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='d']"/>
 <xsl:with-param name="langLabel">Gesprochene Sprache: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='h']"/>
 <xsl:with-param name="langLabel">Originalsprache: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='j']"/>
 <xsl:with-param name="langLabel">Sprache der Untertitel: </xsl:with-param>
 </xsl:call-template>
 </span>
 </xsl:for-each>
 </xsl:if>
 ...
 <span class="results_summary series"><span class="label">Reihen: </span>
 <!-- 440 -->
 ...
 <span class="label">Inhaltswarnung: </span>
